...
const Form = () => {
    return (
        <div className='flex justify-center'>
            <form class="flex flex-col gap-4 bg-slate-800 p-4 rounded-md w-[600px] mt-10">
                ...
                <input className='px-3 py-4 text-white text-xl bg-slate-600 rounded-md' type="submit" value="Upload image"/>
            </form>
        </div>
    )
}
